...
import { updateLandfills } from "../graphql/mutations";
const client = generateClient();
export default function LandfillsUpdateForm(props) {
  const {
    id: idProp,
    landfills: landfillsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = landfillsRecord
      ? { ...initialValues, ...landfillsRecord }
      : initialValues;
  ...
  const [landfillsRecord, setLandfillsRecord] =
    React.useState(landfillsModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getLandfills.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getLandfills
        : landfillsModelProp;
      setLandfillsRecord(record);
    };
    queryData();
  }, [idProp, landfillsModelProp]);
  React.useEffect(resetStateValues, [landfillsRecord]);
  const validations = {
    name: [],
    address: [],
    city: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateLandfills.replaceAll("__typename", ""),
            variables: {
              input: {
                id: landfillsRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "LandfillsUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || landfillsModelProp)}
